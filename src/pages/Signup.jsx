    ...
    return (
      <div style={{ minHeight:'100vh', background:'#0a0a0a', display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', padding:24 }}>
        <div style={{ textAlign:'center', maxWidth:380 }}>
          ...
          <h1 style={{ fontSize:28, fontWeight:800, color:'white', marginBottom:8 }}>You're in!</h1>
          <p style={{ fontSize:15, color:'rgba(255,255,255,0.5)', marginBottom:32, lineHeight:1.6 }}>Check your email for a confirmation link, then come back and sign in to start your stewardship journey.</p>
          <Link to="/login">
  ...
  return (
    <div style={{ minHeight:'100vh', background:'#0a0a0a', display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', padding:'24px', position:'relative', overflow:'hidden' }}>
      ...
      <div style={{ textAlign:'center', marginBottom:32 }}>
        ...
        <h1 style={{ fontSize:26, fontWeight:800, color:'white', margin:'0 0 4px' }}>Create your account</h1>
        <p style={{ fontSize:14, color:'rgba(255,255,255,0.4)', margin:0 }}>Start your stewardship journey today</p>
      </div>

      {/* Benefits */}
      <div style={{ width:'100%', maxWidth:420, marginBottom:24 }}>
        {['Track income, expenses & investments', 'Follow the 30-day $100 Challenge', 'Join a faith-based community'].map((b,i) => (
      ...
      <div style={{ width:'100%', maxWidth:420, background:'rgba(255,255,255,0.05)', borderRadius:20, padding:'32px 28px', border:'1px solid rgba(255,255,255,0.1)' }}>
        ...
        <form onSubmit={handleSignup} style={{ display:'flex', flexDirection:'column', gap:14 }}>
          <div>
            <label style={{ fontSize:12, color:'rgba(255,255,255,0.5)', fontWeight:500, display:'block', marginBottom:6, letterSpacing:'0.05em' }}>FULL NAME</label>
          ...
          <div>
            <label style={{ fontSize:12, color:'rgba(255,255,255,0.5)', fontWeight:500, display:'block', marginBottom:6, letterSpacing:'0.05em' }}>EMAIL</label>
            <input type="email" placeholder="you@example.com" value={email} onChange={e => setEmail(e.target.value)} required
              style={{ width:'100%', padding:'14px 16px', background:'rgba(255,255,255,0.07)', border:'1px solid rgba(255,255,255,0.12)', borderRadius:10, fontSize:15, color:'white', outline:'none', boxSizing:'border-box' }} />
          </div>
          <div>
            <label style={{ fontSize:12, color:'rgba(255,255,255,0.5)', fontWeight:500, display:'block', marginBottom:6, letterSpacing:'0.05em' }}>PASSWORD</label>
        ...
        <div style={{ textAlign:'center', marginTop:20, fontSize:14, color:'rgba(255,255,255,0.4)' }}>
          ...
          <Link to="/login" style={{ color:'#1D9E75', textDecoration:'none', fontWeight:600 }}>Sign in</Link>
        </div>
      </div>

      <p style={{ marginTop:24, fontSize:11, color:'rgba(255,255,255,0.2)', textAlign:'center' }}>Free forever · No credit card required</p>
    </div>
  )
}
