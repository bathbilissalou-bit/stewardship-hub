    ...
    return (
      <div style={{ minHeight:'100vh', background:'#0a0a0a', display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', padding:24 }}>
        <div style={{ textAlign:'center', maxWidth:380 }}>
          ...
          <h1 style={{ fontSize:28, fontWeight:800, color:'white', marginBottom:8 }}>Check your email</h1>
          <p style={{ fontSize:15, color:'rgba(255,255,255,0.5)', marginBottom:32, lineHeight:1.6 }}>We sent a password reset link to <strong style={{color:'white'}}>{email}</strong>. Click the link to reset your password.</p>
          <Link to="/login"><button style={{ padding:'14px 32px', background:'linear-gradient(135deg, #1D9E75, #0F6E56)', color:'white', border:'none', borderRadius:10, fontSize:16, fontWeight:700, cursor:'pointer' }}>Back to Sign In</button></Link>
        </div>
      </div>
    )
  }
    ...
    <div style={{ minHeight:'100vh', background:'#0a0a0a', display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', padding:24 }}>
      <div style={{ width:'100%', maxWidth:420 }}>
        <div style={{ textAlign:'center', marginBottom:32 }}>
          ...
          <h1 style={{ fontSize:24, fontWeight:800, color:'white', margin:'0 0 4px' }}>Reset password</h1>
          <p style={{ fontSize:14, color:'rgba(255,255,255,0.4)', margin:0 }}>We'll send you a reset link</p>
        </div>
        ...
        <div style={{ background:'rgba(255,255,255,0.05)', borderRadius:20, padding:'32px 28px', border:'1px solid rgba(255,255,255,0.1)' }}>
          ...
          <div style={{ textAlign:'center', marginTop:20, fontSize:14, color:'rgba(255,255,255,0.4)' }}>
            Remember it? <Link to="/login" style={{ color:'#1D9E75', textDecoration:'none', fontWeight:600 }}>Sign in</Link>
          </div>
        </div>
      </div>
    </div>
