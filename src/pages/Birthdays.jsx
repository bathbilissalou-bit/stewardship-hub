  ...
  return (
    <div style={{ paddingBottom: 100 }}>
      ...
      <div style={{ background: 'linear-gradient(135deg, #E91E63, #C2185B)', borderRadius: '16px 16px 0 0', padding: '20px 16px 32px', marginBottom: '-16px', color: 'white' }}>
        ...
        <h2 style={{ color: 'white', margin: '0 0 4px', fontSize: 22, fontWeight: 800 }}>Birthday Reminders</h2>
        <p style={{ color: 'rgba(255,255,255,0.85)', margin: 0, fontSize: 13 }}>Never miss a birthday — family, friends & more</p>
      </div>
      ...
      <div style={{ padding: '24px 16px 0' }}>
        ...
        {loading ? (
          ...
          <div style={{ textAlign: 'center', padding: 40 }}>
            ...
            <div style={{ fontWeight: 700, color: 'var(--text)', marginBottom: 6 }}>No birthdays yet</div>
            <div style={{ color: '#9ca3af', fontSize: 13 }}>Add family & friends to never miss their special day</div>
          </div>
        ) : (
          <>
            {upcoming.length > 0 && (
        ...
        <div style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.5)', zIndex: 1000, display: 'flex', alignItems: 'flex-end', justifyContent: 'center' }}>
          <div style={{ background: 'var(--white)', borderRadius: '20px 20px 0 0', padding: 24, width: '100%', maxWidth: 480 }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 20 }}>
              <h3 style={{ margin: 0, fontSize: 18, fontWeight: 800 }}>{editId ? 'Edit Birthday' : 'Add Birthday'}</h3>
            ...
            <div style={{ marginBottom: 14 }}>
              <div style={{ fontSize: 12, fontWeight: 600, color: '#6b7280', marginBottom: 6 }}>Birthday</div>
            ...
            <div style={{ marginBottom: 20 }}>
              <div style={{ fontSize: 12, fontWeight: 600, color: '#6b7280', marginBottom: 6 }}>Note (optional)</div>
              <input
                value={note}
                onChange={e => setNote(e.target.value)}
                placeholder="e.g. Get a cake, Call her..."
            ...
            <button
              ...
              {saving ? 'Saving...' : editId ? 'Save Changes' : 'Add Birthday'}
            </button>
          </div>
        </div>
      )}
